...
export const RESUME_DATA = {
  ...
  about:
     "Cloud Infrastructure and DevOps Architect || Sr. DevOps Engineer || Technical Lead || Transformation Change-Agent || Critical Thinker and Probelm Solver || Collaboration and Communication Expert",  
